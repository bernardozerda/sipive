                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <input type="text"
                                                   ...
                                                   onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                   onBlur="this.style.backgroundColor = '#FFFFFF'; soloNumeros( this ); sumarAreas( 'areaTotal' );"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="txtExistencia" 
												   ...
												   {if $seqTipoEsquema ==1}disabled{/if}
                                            ><option value="">Seleccione</option>
                                            <option value="si" {if $claDesembolso->arrTecnico.txtExistencia == "si"} selected {/if} >Sí</option>
                                            <option value="no" {if $claDesembolso->arrTecnico.txtExistencia == "no"} selected {/if} >No</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
