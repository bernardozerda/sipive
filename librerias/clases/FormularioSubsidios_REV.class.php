        ...
        public function editarFormulario($seqFormulario) {
            ...
            $sql = "
                    UPDATE T_FRM_FORMULARIO SET 
						...
						seqProyectoHijo = \"" . $this->seqProyectoHijo . "\",
						...
						if (($estadoActual == 15 || $etapaActual == 5) && ($flagActualizar == 1)) {
							...
							if($this->bolCerrado == 0){
								$sql .= "bolCerrado  =   \"" . $this->bolCerrado . "\", ";
							} else {
								if($_SESSION['privilegios']['cambiar'] == 1){	
									$sql .= "bolCerrado  =   \"" . $this->bolCerrado . "\", ";
								}
							}
							$sql .= "seqEstadoProceso  =   \"" . $this->seqEstadoProceso . "\", ";
                ...
                ";
			//echo $sql;
			//echo "CAMBIAR: ".$_SESSION['privilegios']['crear'];
