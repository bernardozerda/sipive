<?php
	...
	class Seguimiento {
	    ...
	    function Seguimiento() {
			...
			$this->arrConversionCampos['bolDesplazado']['nombre'] 		= "Desplazado";
			...
			$this->arrConversionCampos['seqProyecto']['tabla'] 					= "T_FRM_PROYECTO";
			...
			$this->arrIgnorarCampos[] = "bolSoporteDocumento";
			$this->arrIgnorarCampos[] = "arrErrores";
			$this->arrIgnorarCampos[] = "bolViabilizada";
			...
			$this->arrIgnorarCampos[] = "txtSoporteSubsidio";
			...
			$this->arrIgnorarCampos[] = "fchVencimiento";
			...
			$this->arrTipoDato['fchInscripcion'] = "fechahora";
			$this->arrTipoDato['fchNacimiento'] = "fecha";
			$this->arrTipoDato['fchPostulacion'] = "fechahora";
			$this->arrTipoDato['fchUltimaActualizacion'] = "fechahora";
			$this->arrTipoDato['fchVigenciaSubsido'] = "fecha";
		...
		public function cambiosDesembolso( $txtFase , $objAnterior , $arrNuevo ){
			...
			switch( $txtFase ){
				case "Busqueda de la Oferta":   $txtCambios = $this->cambiosDesembolsoBusqueda( $objAnterior , $arrNuevo );  break;					
				case "Revisión Jurídica":       $txtCambios = $this->cambiosRevisionJuridica( $objAnterior , $arrNuevo );    break;
				case "Revisión Técnica":        $txtCambios = $this->cambiosRevisionTecnica( $objAnterior , $arrNuevo );     break;
				case "Escrituración": 		    $txtCambios = $this->cambiosDesembolsoBusqueda( $objAnterior , $arrNuevo );  break;
				case "Estudio de Titulos": 	    $txtCambios = $this->cambiosEstudioTitulos( $objAnterior , $arrNuevo );      break;
				case "Solicitud de Desembolso": $txtCambios = $this->cambiosSolicitudDesembolso( $objAnterior , $arrNuevo ); break;
...
// ----------------------
			...
			if( $claFormulario->seqModalidad != 5 ){
				...
				if( $txtValorAnterior != $txtValorNuevo ){
					$txtValorAnterior = ( $txtValorAnterior == "" )? "Ninguno" : $txtValorAnterior;
					$txtValorNuevo    = ( $txtValorNuevo    == "" )? "Ninguno" : $txtValorNuevo;
					$txtCambios .= $this->txtSeparador . "Observaciones Escritura Pública, Valor Anterior: " . ucwords( $txtValorAnterior ). ", " . 
								   "Valor Nuevo: " . ucwords( $txtValorNuevo ) . $this->txtSalto;
				}	
				...
				// Folios Tres Recibos de Servicios Públicos
		...
		private function cambiosRevisionTecnica( $objAnterior , $arrNuevo ){
			...
			$txtCambios .= $this->comparacionTexto( $objAnterior->arrTecnico , $arrNuevo , "txtAprobo" , "Aprobó" );
			...
			$txtCambios .= $this->comparacionTexto( $objAnterior->arrTecnico , $arrNuevo , "txtMultiple" , "Observación Area Multiple" );
			...
			$txtCambios .= "<b>[ " . $arrNuevo['seqFormulario'] . " ] Vivienda Usada [ Físicas y Estructurales ]:</b>" . $this->txtSalto;
			...
			$txtCambios .= "<b>[ " . $arrNuevo['seqFormulario'] . " ] Vivienda Usada [ Servicios Públicos ]:</b>" . $this->txtSalto;
			...
			$txtCambios .= "<b>[ " . $arrNuevo['seqFormulario'] . " ] Vivienda Usada [ Registro Fotográfico ]:</b>" . $this->txtSalto;		
		...
		private function cambiosConsignaciones( $objAnterior , $arrNuevo ){
			...
			$txtCambios .= $this->comparacionTexto( array() , $arrNuevo , "numCuenta" , "Número de cuenta" );
