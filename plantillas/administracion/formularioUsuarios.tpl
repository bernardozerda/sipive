...
<form onSubmit="
    ...
    <table cellspacing="0" cellpadding="1" border="0" width="100%">
        ...
        <tr>
            <th class="tituloCampo">Dependecia</th>
            <td colspan="2">
                <select name="seqDependencia"
                        id="seqDependencia"
                        style="width:200px"
                        >
                    <option value="0">Seleccione una opción</option>
                    {foreach from=$arrDependencia key=seqDependencia item=txtdependencia}
                        <option value="{$seqDependencia}"{if $objUsuario->seqDependencia==$seqDependencia} selected {/if} >{$txtdependencia}</option>
                    {/foreach}
                </select>
            </td>
        </tr>
        <tr>
            <th class="tituloCampo">Matricula</th>
            <td colspan="2">
                <input	class="inputLogin" 
                       name="txtMatriculaProfesional" 
                       type="text" 
                       id="txtMatriculaProfesional" 
                       value="{$objUsuario->txtMatriculaProfesional}" 
                       onBlur="sinCaracteresEspeciales(this);"
                       style="width:250px"
                       />
            </td>
