...
//echo $registros;
    if ($registros > 0) {
        ...
        $objPHPExcel->getSheet(1)->SetCellValue("BA3", "NO");
        $objPHPExcel->getSheet(1)->SetCellValue("BA4", "NO APLICA");
        $objPHPExcel->addNamedRange(
                new PHPExcel_NamedRange(
                'seleccion1', $objPHPExcel->getSheet(1), 'BA2:BA4'
                )
        );
        //Autosize Columnas
        for ($col = 'C'; $col !== 'K'; $col++) {
