<?php
    ...
    $sql = "
        SELECT T_COR_USUARIO.seqUsuario as idUsuario,
			   ...
			   T_COR_USUARIO.txtUsuario as usuario,
			   ...
			   IF (T_COR_USUARIO.bolActivo = 1,'Activo','Inactivo') as Estado,
			   T_COR_USUARIO.fchVencimientoClave as FechaVigencia,
         ...
         WHERE T_COR_PROYECTO.seqProyecto IN (3, 6)
    ";
