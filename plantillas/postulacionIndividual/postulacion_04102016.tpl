	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" style="z-index:999999;">
		<tr>
			<td width="150px" align="center">
				{if $txtImpresion != ""}
					<a href="#" onClick="javascript: {$txtImpresion}">Imprimir Formulario</a>
				{/if}
			</td>
			<!-- Si la ETAPA del hogar es INSCRIPCIÓN (1) 'NO MUESTRA' el campo 'Cerrar Postulación' -->
			{if $objFormulario->seqEtapa != 1}
					<td align="center">
						{if $txtImpresion != ""}
				...
				<table cellpadding="3" cellspacing="0" border="0" width="100%" style="border: 1px dotted #666666;">
					...
					<tr>
						...
						<td id="tdProyecto" colspan="3" align="left">
							<select onFocus="this.style.backgroundColor = '#ADD8E6';" 
									onBlur="this.style.backgroundColor = '#FFFFFF';" 
									onChange="obtenerDatosProyecto( this , {$objFormulario->seqPlanGobierno} ); obtenerUnidadProyecto(this); obtenerConjuntoResidencial(this); "
									name="seqProyecto" 
									id="seqProyecto" 
									style="width:100%"
									>
