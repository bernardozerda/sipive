...
$arrayconjuntos[$seqProyecto]['seqLocalidadHijo'] = $_POST["seqLocalidadHijo"];
$arrayconjuntos[$seqProyecto]['seqBarrioHijo'] = $_POST["seqBarrioHijo"];
...
$arrayconjuntos[$seqProyecto]['valAreaLoteHijo'] = $_POST["valAreaLoteHijo"];
$arrayconjuntos[$seqProyecto]['valTorresHijo'] = $_POST["valTorresHijo"];
...
$arrayconjuntos[$seqProyecto]['fchEjecutoriaLicenciaUrbanismoHijo'] = $_POST["fchEjecutoriaLicenciaUrbanismoHijo"];
...
$arrayconjuntos[$seqProyecto]['txtExpideLicenciaConstruccionHijo'] = $_POST["txtExpideLicenciaConstruccionHijo"];
...
$arrayconjuntos[$seqProyecto]['fchEjecutoriaLicenciaConstruccionHijo'] = $_POST["fchEjecutoriaLicenciaConstruccionHijo"];
$arrayconjuntos[$seqProyecto]['txtNombreVendedorHijo'] = $_POST["txtNombreVendedorHijo"];
$arrayconjuntos[$seqProyecto]['numTelVendedorHijo'] = $_POST["numTelVendedorHijo"];
$arrayconjuntos[$seqProyecto]['txtCorreoVendedorHijo'] = $_POST["txtCorreoVendedorHijo"];
$arrayconjuntos[$seqProyecto]['seqTipoDocumentoVendedorHijo'] = $_POST["seqTipoDocumentoVendedorHijo"];
