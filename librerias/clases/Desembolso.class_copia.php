        ...
        global $aptBd;
         ...
         $sql = "
				SELECT
                    ...
                    esc.numContratoLeasing,
                    esc.fchContratoLeasing,
                    esc.numFoliosContratoLeasing,
                    esc.txtFoliosContratoLeasing
...
// Fin guardar desembolso
    ...
    public function salvarEscrituracion($arrPost, $txtFase) {
        ...
        $fchContratoLeasing = ( esFechaValida( $arrPost['fchContratoLeasing'] ))? "'" . $arrPost['fchContratoLeasing'] . "'" : "NULL";
        ...
        if ($seqEscrituracion == 0) {
            ...
            $sql = "
                INSERT INTO T_DES_ESCRITURACION (
                    ...
                    '" . $arrPost['txtCorreoVendedor'] . "',
                    '" . $arrPost['seqCiudad'] . "',
                    '" . intval($arrPost['numContratoLeasing']) . "',
                    " . $fchContratoLeasing . ",
                    '" . intval($arrPost['numFoliosContratoLeasing']) . "',
                    '" . intval($arrPost['txtFoliosContratoLeasing']) . "',                    
                    $txtValores
                )
	 		";
            try {
            ...
            $sql = "
                UPDATE T_DES_ESCRITURACION SET
                    ...
                    numContratoLeasing = " . intval($arrPost['numContratoLeasing']) . ",
                    fchContratoLeasing = " . $fchContratoLeasing . ",
                    numFoliosContratoLeasing = " . intval($arrPost['numFoliosContratoLeasing']) . ",
                    txtFoliosContratoLeasing = '" . trim($arrPost['txtFoliosContratoLeasing']) . "',
                    $txtCampos
                WHERE
                    seqFormulario = " . $arrPost['seqFormulario'] . "
			";
