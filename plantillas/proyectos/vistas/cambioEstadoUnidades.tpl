    ...
    <div id="wrapper" class="container tab-content">
        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 100%">                
            ...
            <li class="nav-item active"  style="{$nav}">       
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#estados" role="tab" aria-controls="profile" aria-selected="false" style="{$styleLic}" >Cambio de Estado Unidades <br></a>
            </li>
        </ul>        
