...
<table border="0" cellspacing="2" cellpadding="0" width="100%">
	<tr>
		...
		<td class="campoNivel1" width="15%">$ <input type="text" class="campoValornivell" name="valActTerreno" id="valActTerreno" value="{$objFormularioProyecto->valActTerreno}" onBlur="sinCaracteresEspeciales( this ); soloNumeros( this );"></td>
	</tr>
</table>
