...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<td align="left">( <a type="text" style="cursor:pointer;" onclick="reporteTotalHoySemanaDia( 'hoy', '{$txtEstado}' );" >{$numTotalHoy}</a> )</td>
	</tr>
	<tr>
		<td><input type="radio" id="tipoDesembolsoRango" name="tipoDesembolsoRango" value="semana" >Semana</td>
		<td align="left">( <a type="text" style="cursor:pointer;" onclick="reporteTotalHoySemanaDia( 'semana', '{$txtEstado}' );" >{$numTotalSemana}</a> )</td>
	</tr>
	<tr>
		<td><input type="radio" id="tipoDesembolsoRango" name="tipoDesembolsoRango" value="mes" >Mes</td>
		<td align="left"> ( <a type="text" style="cursor:pointer;" onclick="reporteTotalHoySemanaDia( 'mes', '{$txtEstado}' );" >{$numTotalMes}</a> )</td>
	</tr>
</table>