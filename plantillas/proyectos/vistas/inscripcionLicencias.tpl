        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-4"> 
                    ...
                    <input name="txtLicencia[]" type="text" id="txtLicenciaUrbanismo_1" value="{$valueLic.txtLicencia}" onblur="sinCaracteresEspeciales(this);" style="width:200px;" class="form-control required">
                ...
                <div class="col-md-4"> 
                    ...
                    <input name="txtExpideLicencia[]" type="text" id="txtExpideLicenciaUrbanismo_1" value="{$valueLic.txtExpideLicencia}" onblur="sinCaracteresEspeciales(this);" style="width:200px;" class="form-control required">
                ...
                <div class="col-md-4">
                    ...
                    <input name="txtResEjecutoria[]" type="text" id="txtResEjecutoria_1" value="{$valueLic.txtResEjecutoria}" onblur="sinCaracteresEspeciales(this);"   style="width:200px;" class="form-control required">
    ...
    {if $valueLic.seqTipoLicencia == 2 || $valueLic.seqTipoLicencia ==""}
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-4"> 
                    <label class="control-label">N&uacute;mero de Licencia</label> 
                    <input name="txtLicencia[]" type="text" id="txtLicenciaConstructor" value="{$valueLic.txtLicencia}" onblur="sinCaracteresEspeciales(this);" style="width:200px;" class="form-control required">
                    <input type="hidden" name="seqProyectoLicencia[]" id="seqProyectoLicencia[]" value="{$valueLic.seqProyectoLicencia}" >
                ...
                <div class="col-md-4"> 
                    <label class="control-label">Fecha de Licencia</label> 
                    <input name="fchLicencia[]" type="text" id="fchLicenciaC" value="{$valueLic.fchLicencia}" size="12" readonly=""  class="form-control required"  style="width: 70%; position: relative; float: left">
                ...
                <div class="col-md-4">
                    <label class="control-label">Vigencia de Licencia</label> 
                    <input name="fchVigenciaLicencia[]" type="text" id="fchVigenciaLicenciaC" value="{$valueLic.fchVigenciaLicencia}" size="12" readonly="" class="form-control required"  style="width: 70%; position: relative; float: left">
