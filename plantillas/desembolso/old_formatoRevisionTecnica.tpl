			...
			<table cellpadding="2" cellspacing="0" border="0" width="100%" style="border: 1px solid #999999; {$txtFuente12}">
				...
				<tr><td colspan="2" style="padding-left:30px; padding-right:30px;">
					...
					Para constacia se firma por parte del responsable en el área técnica.<br><br><br><br>
						...
						<p>Matricula Profesional: _______________________________________</p>
...
<!-- INICIO PAGINA 1 -->
		...
		<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
			...
			<tr>
				...
				<td>{$claDesembolso->numTelefonoVendedor}</td>
			</tr>
			...
			<!-- PROYECTO, MODALIDAD -->
			<tr>
				<td>{$arrProyectos.$seqModalidad.$seqProyecto}</td>
				<td>{$claDesembolso->txtDireccionInmueble}</td>
			...
			<tr>
				...
				<td>{$claDesembolso->txtBarrio}</td>
				<td>{$claDesembolso->txtTipoPredio}</td>
			</tr>

			<tr> 
				<td><b>Matricula:</b><br/>{$claDesembolso->txtMatriculaInmobiliaria}</td>
				<td><b>Chip:</b><br/>{$claDesembolso->txtChip}</td>
				<td></td>
			</tr>
...
<!-- INICIO PAGINA 2 -->
		...
		<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
			...
			<tr bgcolor="{cycle name=c3 values="#EAEAEA,#FFFFFF"}">
				...
				<td align="right">{$claDesembolso->arrTecnico.numContadorAgua|number_format:0:',':'.'}</td>
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" style="{$txtFuente10}">
			...
			<tr>
				<td><table valign="bottom"  cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}" ><tr><td>
				...
				<td height="120px" valign="bottom" align="right" style="padding: 20px">
					...
					M.P. ________________________________________<br><br>
					{$txtUsuarioSesion}
				</td>
				</td></tr></table></td>
			</tr>
