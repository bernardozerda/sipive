	...
	Class FlujoDesembolso {
		...
		private function obtenerFases( $seqFormulario = 0 ){
         ...
         $arrFases['postulacionIndividual']['escrituracion']['nombre'] = utf8_encode("Escrituracion");
			$arrFases['postulacionIndividual']['escrituracion']['permisos']  = array( 15,17,23,26,27,28,29,40 );
			$arrFases['postulacionIndividual']['escrituracion']['adelante']  = array( 15,17,23,27 );
