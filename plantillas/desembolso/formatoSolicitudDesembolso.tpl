	...
	<body> <!-- onLoad="window.print();" -->
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%" style="border: 1px solid #999999;">
			...
			<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
				<tr><td colspan="2" style="padding:5px; {$txtFuente12}" ><b>Beneficiario del Subsidio</b></td></tr>
				<tr>
			...
			<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
				<tr><td colspan="2" style="padding:5px; {$txtFuente12}" bgcolor=""><b>Beneficiario del Pago</b></td></tr>
				<tr>
				...
				<tr>
					<td><b>{if $claDesembolso->arrEscrituracion.txtTipoDocumentos == "juridica"}NIT{else}Documento{/if} del Vendedor:</b></td>
					<td>
			...
			<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
				<tr><td colspan="2" style="padding:5px; {$txtFuente12}" bgcolor=""><b>Beneficiario del Giro</b></td></tr>
				<tr>
			...
			<!-- CERTIFICACION -->
			<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
				<tr><td style="padding:5px; {$txtFuente12}" bgcolor=""><b>Certificación</b></td></tr>
			...
			<table cellspacing="0" cellpadding="1" border="0" width="100%" style="{$txtFuente10}">
				...
				<tr><td style="padding:5px; {$txtFuente12}" bgcolor="" colspan="3"><b>Se Adjuntaron los siguientes documentos:</b></td></tr>	
				...
				<td height="20px" colspan="4">&nbsp;</td>
					...
					<tr>
						...
						{if $arrSolicitud.txtSubdireccion|trim != ""}
								{$arrSolicitud.txtSubdireccion|mb_strtolower|mb_strtoupper}<br>
					...
					{/if}				
						...
						{if $arrSolicitud.txtSubsecretaria != ""}
								{$arrSolicitud.txtSubsecretaria|mb_strtolower|mb_strtoupper}<br>
