...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title">Listado de Giros a Fiducia</h6>
    </div>
    <div class="panel-body">
        ...
        <table id="listadoAadPry" data-order='[[ 0, "desc" ]]' class="table table-striped table-condensed table-hover" width="100%">
            ...
            <tbody>
                {foreach from=$arrListado key=seqGiroFiducia item=arrItemGiro}
                    <tr>
    ...
    <div class="modal-footer">
        <div class="col-sm-12 text-center">
            <button type="button" class="btn btn-primary" onclick="cargarContenido('contenido','./contenidos/pryGestionFinanciera/giroFiducia.php','',true);">Nuevo Giro</button>
        </div>
    </div>
</div>
