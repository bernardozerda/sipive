...
{assign var=archivoDesembolso 				value=$arrExportables.archivoDesembolso}
        ...
        <table cellspacing="0" cellpadding="3" border="0" width="90%">
            ...
            {/if}
                ...
                {if $reporteEscrituracion == 1}
                    <tr {if $x is not even} style="background:#{$backColor};" {/if}>
                        <td class="tituloCampo" align="left">Reporte de Escrituración</td>
                        <td class="tituloCampo" align="left">{assign var=x  value=$x+1}
                            <a onclick="someterFormulario(
                                            'mensajes',
                                            'listadoExportable',
                ...
                {if $archivoDesembolso == 1}
                    <tr {if $x is not even} style="background:#{$backColor};" {/if}>
                        <td class="tituloCampo" align="left" width="60%">Reporte Archivo Desembolsos</td>
                        <td class="tituloCampo" align="left">{assign var=x  value=$x+1}
                            <a href="./recursos/descargables/desembolso/LinkImpresion.xlsx">Exportable</a>
                        </td>
                    </tr>
                {/if}
