...
if ($_POST['seqDependencia'] == 0) {
    $arrErrores[] = "Seleccione una Dependencia";
}
...
if (empty($arrErrores)) {
    ...
    if (isset($_POST['seqEditar']) and is_numeric($_POST['seqEditar']) and $_POST['seqEditar'] > 0) {
        ...
        $arrErrores = $claUsuario->editarUsuario($_POST['seqEditar'], $_POST['nombre'], $_POST['apellido'], $_POST['usuario'], $_POST['clave'], $_POST['correo'], $_POST['estado'], $_POST['vencimiento'], $_POST['proyectoGrupo'], $_POST['seqDependencia'], $_POST['txtMatriculaProfesional'], $arrPrivilegios);
        ...
        $arrErrores = $claUsuario->guardarUsuario($_POST['nombre'], $_POST['apellido'], $_POST['usuario'], $_POST['clave'], $_POST['correo'], $_POST['estado'], $_POST['vencimiento'], $_POST['proyectoGrupo'], $_POST['seqDependencia'], $_POST['txtMatriculaProfesional'], $arrPrivilegios);
