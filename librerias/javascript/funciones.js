...
function cuadroBusquedaAvanzada(idDestino) {
    ...
    if (objCuadro.style.display == "none") {
        numAlto = 100;
        //objIcono.innerHTML = "-";
    } else {
        numAlto = 1;
...
function buscarSeguimientoProyectos(txtDivDestino, txtArchivo) {
    ...
    var objFechaFinal = document.getElementById("final");
    var objComentario = document.getElementById("comentario");
    var objSeguimiento = document.getElementById("seqProyecto");
...
function addCronogramaFechas() {
    ...
    var addDiv = "";
    addDiv += "<td><div class='form-group'><div class='col-md-3'><label class='control-label' >Acta Descriptiva</label><br />Num. <input name='numActaDescriptiva[]' type='text' id='numActaDescriptiva_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this );' size='5' style='text-align:center'/> A&ntilde;o <input name='numAnoActaDescriptiva[" + indiceFilaFormulario + "]' type='text' id='numAnoActaDescriptiva[" + indiceFilaFormulario + "]' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this );' size='5' style='text-align:center'/></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Inicio</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchInicialProyecto[]' type='text' id='fchInicialProyecto_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly class='form-control required5'/></div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Terminación</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchFinalProyecto[]' type='text' id='fchFinalProyecto_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly class='form-control required5'/></div></div>";
    ...
    addDiv += "<div class='col-md-3'><label class='control-label'>Inicio</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchInicialEntrega[]' type='text' id='fchInicialEntrega_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly  class='form-control required5'  /></div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Terminación Venta</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchFinalEntrega[]' type='text' id='fchFinalEntrega_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly class='form-control required5'/></div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Inicio</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchInicialEscrituracion[]' type='text' id='fchInicialEscrituracion_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly class='form-control required5'/></div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Terminación</label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchFinalEscrituracion[]' type='text' id='fchFinalEscrituracion_" + indiceFilaFormulario + "' size='12' style='text-align:center' readonly class='form-control required5'/></div>";
    addDiv += "<img src='recursos/imagenes/remove.png' width='22px' onclick='return confirmaRemoverLineaFormulario(this);' style='position: relative; float: right; right: 15%'></div><p>&nbsp;</p></div></td><div id='divCalendar' style='display:none'></div>";
    myNewCell = myNewRow.insertCell(-1);
...
function addTipoVivienda() {
    ...
    myNewRow.id = indiceFilaFormulario;
    indiceFilaFormulario = ($("#tablaTipoVivienda tr").length);
    var addDiv = "";
    addDiv += "<td><div class='form-group'><div class='col-md-3'><label class='control-label' >Nombre</label><br /><select name=\"txtNombreTipoVivienda[]\" id=\"txtNombreTipoVivienda\" style=\"width:160px\" class=\"form-control required3\"> <option value=''>Seleccione Tipo Vivienda</option><option value=\"Apartamento tipo VIS\">Apartamento tipo VIS</option><option value=\"Apartamento tipo VIP\">Apartamento tipo VIP</option><option value=\"Casa tipo VIS\">Casa tipo VIS</option><option value=\"Casa tipo VIP\">Casa tipo VIP</option><option value=\"Otro tipo NO VIS/VIP\">Otro tipo NO VIS/VIP</option></select><div id=\"val_txtNombreTipoVivienda_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Total Uds</label><br /><input type='text' name='numCantidad[]' id='numCantidad_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this ); sumaVentas();' style='width:50px; text-align:right' class=\"form-control required3\"><div id=\"val_numCantidad_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Uds. Discapacitados</label><br /><input type=\"text\" name=\"numCantUdsDisc[]\" id=\"numCantUdsDisc_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this);  soloNumeros(this);\" class=\"form-control required3\"><div id=\"val_numCantUdsDisc_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div> ";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Total Parq.</label><br /><input type=\"text\" name=\"numTotalParq[]\" id=\"numTotalParq_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this); soloNumeros(this);\" class=\"form-control required3\"><div id=\"val_numTotalParq_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div> ";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Cant. Parq Discapacitados</label><br /><input type=\"text\" name=\"numCantParqDisc[]\" id=\"numCantParqDisc_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this);soloNumeros(this);\"  class=\"form-control required3\"><div id=\"val_numCantParqDisc_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div> ";
    addDiv += "<div class='col-md-3'><label class='control-label'>&Aacute;rea</label><br /><input type='text' name='numArea[]' id='numArea_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this );' style='width:50px; text-align:right' class=\"form-control required3\"><div id=\"val_numArea_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>A&ntilde;o Venta</label><br /><input type='text' name='numAnoVenta[]' id='numAnoVenta_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this );' style='width:50px; text-align:right'  class=\"form-control required4\"><div id=\"val_numAnoVenta_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Precio Venta</label><br /><input type='text' name='valPrecioVenta[]' id='valPrecioVenta_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this ); sumaVentas();' style='width:80px; text-align:right' class=\"form-control required4\"><div id=\"val_valPrecioVenta_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label'>Cierre</label><br /> <input type='text' name='valCierre[]' id='valCierre_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this );' style='width:80px; text-align:right' class=\"form-control required4\"><div id=\"val_valCierre_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
    addDiv += "<div class='col-md-6'><label class='control-label'>Descripci&oacute;n</label><br /><textarea name='txtDescripcion[]' id='txtDescripcion_" + indiceFilaFormulario + "' style='width:260px' class=\"form-control required4\"></textarea><div id=\"val_txtDescripcion_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar</div></div>";
...
function addConjuntoResidencial() {
    ...
    addDiv += "<div class='col-md-3'><label class='control-label' >No. Escritura </label><br /><input type='text' name='txtEscrituraHijo[]' id='txtEscrituraHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='12' class=\"form-control required4\"><div id=\"val_txtEscrituraHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Escritura </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchEscrituraHijo[]' type='text' id='fchEscrituraHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchEscrituraHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >No. Notar&iacute;a </label><br /><input type='text' name='numNotariaHijo[]' id='numNotariaHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='12' class=\"form-control required4\"><div id=\"val_numNotariaHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div><div class='col-md-6'> <p>&nbsp;</p></div></div>";
    ...
    addDiv += "<div class='col-md-3'><label class='control-label' >Lic. Urbanismo </label><br /><input type='text' name='txtLicenciaUrbanismoHijo[]' id='txtLicenciaUrbanismoHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='18' class=\"form-control required4\" ><div id=\"val_txtLicenciaUrbanismoHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Entidad Expedici&oacute;n </label><br /><input type='text' name='txtExpideLicenciaUrbanismoHijo[]' id='txtExpideLicenciaUrbanismoHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='13'class=\"form-control required4\" ><div id=\"val_txtExpideLicenciaUrbanismoHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Licencia </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchLicenciaUrbanismo1Hijo[]' type='text' id='fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\" /></div><div id=\"val_fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Vigencia&nbsp;Licencia </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchVigenciaLicenciaUrbanismoHijo[]' type='text' id='fchVigenciaLicenciaUrbanismoHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha Ejecutoria </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchEjecutoriaLicenciaUrbanismoHijo[]' type='text' id='fchEjecutoriaLicenciaUrbanismoHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchEjecutoriaLicenciaUrbanismoHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";

    addDiv += "</fieldset></div></div>";
    addDiv += "<div class='col-md-12'> <fieldset><legend class='legend'> <h4 style='position: relative; float: left; width: 50%;  margin: 0px; padding: 5px8'>  Licencia de Construccion</h4> </legend>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Lic. Construcci&oacute;n </label><br /><input type='text' name='txtLicenciaConstruccionHijo[]' id='txtLicenciaConstruccionHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='18' ><div id=\"val_txtLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Entidad Expedici&oacute;n </label><br /><input type='text' name='txtExpideLicenciaConstruccionHijo[]' id='txtExpideLicenciaConstruccionHijo_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this );' size='13'class=\"form-control required4\" ><div id=\"val_txtExpideLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Licencia </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchLicenciaConstruccion1Hijo[]' type='text' id='fchLicenciaConstruccion1Hijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchLicenciaConstruccion1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Vigencia&nbsp;Licencia </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchVigenciaLicenciaConstruccionHijo[]' type='text' id='fchVigenciaLicenciaConstruccionHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchVigenciaLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha Ejecutoria </label><br /><div class='inner-addon left-addon'><i class='glyphicon glyphicon-calendar'></i><input name='fchEjecutoriaLicenciaConstruccionHijo[]' type='text' id='fchEjecutoriaLicenciaConstruccionHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/></div><div id=\"val_fchEjecutoriaLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    ...
    addDiv += " <p>&nbsp;</p></div></td><div id='divCalendar' style='display:none'></div>";
    myNewCell = myNewRow.insertCell(-1);
    myNewCell.innerHTML = addDiv;
    indiceFilaFormulario++;
}
...
function pdfGiroFiducia(seqProyecto, seqGiroFiducia) {
