...
<form name="frmIndividual" id="frmIndividual" onSubmit="{$txtFuncion};
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" style="z-index:999999;">
        <tr>
            ...
            {if $objFormulario->seqEtapa != 1 && $objFormulario->seqEstadoProceso == 54 || $objFormulario->seqEstadoProceso == 7}
                <td align="center">
                    {if $txtImpresion != "" }
