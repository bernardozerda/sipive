<?php
	...
	class Constructor {
		...
		*/
		...
		public function guardarConstructor ( $seqConstructor, $txtNombreConstructor, $seqTipoDocumentoConstructor, $numDocumentoConstructor, $txtDireccionConstructor, $numTelefono1Constructor, $numTelefono2Constructor, $txtCorreoElectronicoConstructor, $txtNombreRepresentanteLegal, $numDocumentoRepresentanteLegal, $txtCorreoElectronicoRepresentanteLegal, $bolActivo ) {
		...
		*/
        ...
        public function editarConstructor( $seqConstructor, $txtNombreConstructor, $seqTipoDocumentoConstructor, $numDocumentoConstructor, $txtDireccionConstructor, $numTelefono1Constructor, $numTelefono2Constructor, $txtCorreoElectronicoConstructor, $txtNombreRepresentanteLegal, $numDocumentoRepresentanteLegal, $txtCorreoElectronicoRepresentanteLegal, $bolActivo ) {
            global $aptBd;
            $arrErrores = array();
