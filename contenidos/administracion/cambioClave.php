...
if (empty($arrErrores)) {
    ...
    if (!empty($arrUsuario)) {
        ...
        $arrErrores = $claAutenticacion->editarUsuario(
                $seqUsuario, $arrUsuario[$seqUsuario]->txtNombre, $arrUsuario[$seqUsuario]->txtApellido, $arrUsuario[$seqUsuario]->txtUsuario, $_POST['nueva'], $arrUsuario[$seqUsuario]->txtCorreo, $arrUsuario[$seqUsuario]->bolActivo, $arrUsuario[$seqUsuario]->numVencimiento, $arrPermisos, $arrUsuario[$seqUsuario]->seqDependencia, $arrUsuario[$seqUsuario]->txtMatriculaProfesional, $arrPrivilegios
        );
    } else {
