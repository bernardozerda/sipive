    ...
    public function cargarProyectoVivienda($seqProyecto) {
        ...
        $sql = "
				SELECT
					...
					txtNombreOferente2,
					numNitOferente2,
					txtNombreContactoOferente2,
					numTelefonoOferente2,
					numExtensionOferente2,
					numCelularOferente2,
					txtCorreoOferente2,
					txtNombreOferente3,
					numNitOferente3,
					txtNombreContactoOferente3,
					numTelefonoOferente3,
					numExtensionOferente3,
					numCelularOferente3,
					txtCorreoOferente3,
				...
				LEFT JOIN T_PRY_ENTIDAD_OFERENTE ON (T_PRY_PROYECTO.seqProyecto = T_PRY_ENTIDAD_OFERENTE.seqProyecto)
...
// Fin borrar Proyecto
    ...
    public function buscarNombreProyecto($txtParametro, $numLimiteRegistros = 6) {
        ...
        $sql = "SELECT	CONCAT(txtNombreProyecto,' [',txtNombreOferente,']') AS nombre, T_PRY_PROYECTO.seqProyecto
					FROM	T_PRY_PROYECTO INNER JOIN T_PRY_ENTIDAD_OFERENTE ON (T_PRY_PROYECTO.seqProyecto = T_PRY_ENTIDAD_OFERENTE.seqProyecto)
