    ...
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
            <meta name="title" content="Subsidios de Vivienda">
                ...
                <script language="JavaScript" type="text/javascript" src="./librerias/tinymce/tinymce.min.js"></script>
                ...
                <script language="JavaScript" type="text/javascript" src="./librerias/jquery/jquery.dataTables.min.js"></script>
                <script language="JavaScript" type="text/javascript" src="./librerias/jquery/dataTables.bootstrap.min.js"></script>
                <script language="JavaScript" type="text/javascript" src="./librerias/javascript/dataTable.js"></script>
                ...
                <body class="yui-skin-sam" id="bodyHtml" topMargin="0" style="background-color: white;">
                    <center>&nbsp;
                        <table cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" id="tablePrincipal" class="tablePrincipal" width="1000px">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                ...
                                <tr>
                                    <td id="rutaMenu">
                                        <ol class='breadcrumb text-info h6' style='padding: 10px; margin: 0px;'><li><strong>{$arrProyectos.$seqProyectoPost->txtProyecto}</strong></li></ol>
                                        <input type="hidden" id="seqMenuMigaDePan" value="">
                                    </td>
                                    <td width="350px" align="right">
                                        <ol class='breadcrumb text-info h6' style='padding: 10px; margin: 0px;'>
                                            <li><strong>En sesión:</strong> {$txtNombreUsuario}</li>
                                        </ol>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="3" style="padding-left:10px;" id="mensajes"></td>
                                </tr>
                                <tr>
                                    <td colspan="3" id="contenido" height="550px" aign="left" valign="top" style="padding:10px;">
