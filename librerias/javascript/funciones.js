...
function agregarMiembroHogar() {
    ...
    if (bolValidacionSoporteDocumentos == true) {
        ...
        if (objTpoDocumento.value == 1 || objTpoDocumento.value == 7 || objTpoDocumento.value == 3 || objTpoDocumento.value == 4) {
...
function addTipoVivienda() {
    ...
    var addDiv = "";
    addDiv += "<td><div class='form-group'><div class='col-md-3'><label class='control-label' >Nombre</label><br /><select name=\"txtNombreTipoVivienda[]\" id=\"txtNombreTipoVivienda\" style=\"width:160px\" class=\"form-control\"> <option value=''>Seleccione Tipo Vivienda</option><option value=\"Apartamento tipo VIS\">Apartamento tipo VIS</option><option value=\"Apartamento tipo VIP\">Apartamento tipo VIP</option><option value=\"Casa tipo VIS\">Casa tipo VIS</option><option value=\"Casa tipo VIP\">Casa tipo VIP</option><option value=\"Otro tipo NO VIS/VIP\">Otro tipo NO VIS/VIP</option></select></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Total Uds</label><br /><input type='text' name='numCantidad[]' id='numCantidad_" + indiceFilaFormulario + "' onBlur='sinCaracteresEspeciales( this ); soloNumeros( this ); sumaVentas();' style='width:50px; text-align:right' ></div>";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Uds. Discapacitados</label><br /><input type=\"text\" name=\"numCantUdsDisc[]\" id=\"numCantParqDisc_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this);  soloNumeros(this);\"></div> ";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Total Parq.</label><br /><input type=\"text\" name=\"numTotalParq[]\" id=\"numTotalParq_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this); soloNumeros(this);\"></div> ";
    addDiv += "<div class=\"col-md-3\"><label class=\"control-label\">Cant. Parq Discapacitados</label><br /><input type=\"text\" name=\"numCantParqDisc[]\" id=\"numCantParqDisc_" + indiceFilaFormulario + "\" value=\"\" style=\"width:50px; text-align:right\" onblur=\"sinCaracteresEspeciales(this);soloNumeros(this);\"></div> ";
    ...
    addDiv += "<div class='col-md-6'><label class='control-label'>Descripci&oacute;n</label><br /><textarea name='txtDescripcion[]' id='txtDescripcion' style='width:260px'></textarea></div>";
