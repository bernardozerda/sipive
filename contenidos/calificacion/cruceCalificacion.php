    ...
    foreach ($formularios as $keyF => $valueF) {
        ...
        //if ($arrayDatosEncuentas['errores'][0] != "") {
           ...
           $totalPLGTBI = ($claCalificacion->PLGTBI * ($grupoLGTBI * 100));
            ...
            $totalCalEnc = $totalPPGD + $totalPLGTBI + $totalHCF + $totalHN18 + $totalHPGE + $totalCDISC + $totalHAMY + $totalMCF + $totalHN12 + $totalTDE + $totalIPC + $totalHacinamiento + $totalCohabitacion + $totalRSA + $totalcalBle;
            ?> 
            <tr>
