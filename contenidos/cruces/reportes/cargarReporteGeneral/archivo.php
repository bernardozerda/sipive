            ...
            <div class="well">
                <form method="post" action="migrar.php" enctype="multipart/form-data" id="formcargar" class="form-signin">
                    <div class="form-group">
                        ...
                        <b>Fecha Cruce: (*)</b> <input type="text" name="fchCruce" readonly="readonly" id="datepicker"  style="width: 85px">
                        <br><b>Nombre Grupo Cruce(*)</> <input type="text" name="nombreGrupoCruce" id="nombreGrupoCruce"  style="width: 100px">
