...
$txtPrefijoRuta = "../../";
	...
	$sql = "
       ...
       END
          ...
          WHEN  (frm.valIngresoHogar/".$arrConfiguracion['constantes']['salarioMinimo'].") BETWEEN 0 AND 1 THEN '0 - 1 SMMLV'
          WHEN  (frm.valIngresoHogar/".$arrConfiguracion['constantes']['salarioMinimo'].") BETWEEN 1 AND 2 THEN '1 - 2 SMMLV'
          WHEN  (frm.valIngresoHogar/".$arrConfiguracion['constantes']['salarioMinimo'].") BETWEEN 2 AND 3 THEN '2 - 3  SMMLV'
          WHEN  (frm.valIngresoHogar/".$arrConfiguracion['constantes']['salarioMinimo'].") BETWEEN 3 AND 4 THEN '3 - 4 SMMLV'          
       ...
       IF(
             (    tvh.txtDesplazado = 'Victima'
              AND frm.valTotalRecursos >= 11000000
