    ...
    <form onsubmit="someterFormulario('contenido', this, './contenidos/subsidios/mantenimientoFac.php', true, true); return false;" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h6 class="panel-title">Actualización de formularios de actos administrativos</h6>
            </div>
...
<form id="frmExportarFac" method="post" action="./contenidos/subsidios/exportarFac.php">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Exportable de datos</h6>
        </div>
        <div class="panel-body">
            {foreach from=$arrEstados item=arrEstado}
                <div class="row form-group">
                    <div class="col-sm-1">
                        <input type="checkbox" name="estados[]" value="{$arrEstado.seqEstado}">
                    </div>
                    <div class="col-sm-11">
                        {$arrEstado.txtEstado}
                    </div>
