...
<!-- SALIR DE SESION -->			
			...
			<!-- Mensaje al usuario-->
			<!--
			<div id="mensajeUsuario" style="width: 900px">
                            <tr>
                                <td colspan="3">
                                    <marquee class="marquee_code" direction="left" behavior="scroll" scrollamount="8">
                                        Es importante que el hogar actualice información de contacto, conformación del núcleo familiar y las condiciones para acceder al SDVE.
