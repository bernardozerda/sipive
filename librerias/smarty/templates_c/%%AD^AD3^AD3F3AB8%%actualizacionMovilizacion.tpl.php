<?php /* Smarty version 2.6.26, created on 2017-05-05 16:36:17
         compiled from subsidios/actualizacionMovilizacion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'subsidios/actualizacionMovilizacion.tpl', 594, false),array('modifier', 'number_format', 'subsidios/actualizacionMovilizacion.tpl', 623, false),array('function', 'math', 'subsidios/actualizacionMovilizacion.tpl', 595, false),)), $this); ?>
...
"
    ...
    <?php echo $this->_tpl_vars['nombrePrincipal']; ?>
...
"
                ...
                <div id="pestanasPostulacion" class="yui-navset" style="width:100%; text-align:left;">
                    <ul class="yui-nav">
                        ...
                        <li class="selected"><a href="#movilizacion"><em>Generar Carta</em></a></li>
...
" 
                        ...
                        <div id="movilizacion" style="height:415px;"><p>
                            <table cellpadding="1" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF" height='60%'>
                                <tr>

                                    <td nowrap="nowrap" > Nombre de Postulado(a)</td>
                                    <td colspan="2" align="center"><b><?php echo $this->_tpl_vars['nombrePostulante']; ?>
</b>
                                        <!--   <input	type="text" 
                                                  name="namePostulado1" 
                                                  id="valPostulado1" 
...
"
                                ...
                                <tr>
                                    <!-- TIENE AHORRO -->                                   
                                    <td><input type="radio" value="1" name="radio" id="radio_1" onclick="ocultarDiv();"> Ahorro 1 </td>
                                    <td align="left" style="padding-right: 5px;"  nowrap="nowrap">
                                        $ <input	type="text" 
...
"
                                ...
                                <tr>
                                    <!-- TIENE OTRO AHORRO -->                                    
                                    <td><input type="radio" value="2" name="radio" id="radio_2" onclick="ocultarDiv();"> Ahorro 2</td>
...
"
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="msgError" style="text-align: center;">
                                            <li class="ocultarDiv">Si elige la opción de otro debe diligenciar el campo de Entidad</li></div>
                                    </td></div>
                                </tr>
                                <tr>
                                    <!-- TIENE OTRO AHORRO -->                                    
                                    <td><input type="radio" value="3" name="radio" id="radio_3" onclick="mostrarDiv();"> otro</td>
                                    ...
                                    <!-- BANCO DONDE TIENE EL AHORRO -->
                                    <td><div class="ocultarDiv">Entidad</div></td>
                                    <td align="center" width="320px"><div class="ocultarDiv">
                                            <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                    onBlur="this.style.backgroundColor = '#FFFFFF';"  
                                                    onchange="validarEntidad(this.value);"
...
, 1, '<?php echo $this->_tpl_vars['nombrePostulante']; ?>
')" style="width:70px; text-align: center; border: 1px solid #000; background: #F5F5F5; position: relative; left: 44% ">
...
unset($_smarty_tpl_vars);
 ?>
                <div id="contenidoBusqueda" >dxdgdc
                    <?php $_smarty_tpl_vars = $this->_tpl_vars;
