...
if (isset($_POST['documento']) AND ($_POST['documento'] != '')){
	...
	while (@$rowCruces = mysql_fetch_array ($sqlForm)){
		...
		if (isset($_POST['documento']) AND ($_POST['documento'] != '')){
			...
			echo "<tr><td><b>Fecha Cruce:</b></td><td>".$rowCruces['fchCreacionCruce']."</td></tr>";
			echo "<tr><td><b>Fecha Actualizaci&oacute;n:</b></td><td>".$rowCruces['fchCruce']."</td></tr>";
			...
			echo "<tr><td><b>Fecha Cruce:</b></td><td>".$rowFormulario['fchCreacionCruce']."</td></tr>";
			echo "<tr><td><b>Fecha Actualizaci&oacute;n:</b></td><td>".$rowFormulario['fchCruce']."</td></tr>";
