...
<!-- ################################ NAVBAR NO FUNCIONA EL RESPONSIVE #############################################-->
                    ...
                    {*{if not empty( $objPadre->hijos ) }*}
                        {*<li class="dropdown">*}
                            ...
                            {*<ul class="dropdown-menu">*}
                                ...
                                {*{foreach from=$objPadre->hijos key=seqHijo item=objHijo}*}
                                    {*<li><a href="#menu-{$objHijo->txtEspanol}"*}
                                           {*onClick="cargarContenido('contenido', './contenidos/{$objHijo->txtCodigo}.php', '', true); cargarContenido('rutaMenu', './rutaMenu.php', 'menu={$seqHijo}', false);">{$objHijo->txtEspanol} </a>*}
                                    {*</li>*}
                                {*{/foreach}*}
                            {*</ul>*}
                        {*</li>*}
