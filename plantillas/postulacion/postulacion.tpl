...
{assign var=txtFuncion value=""}

<form name="frmIndividual"
      id="frmIndividual"
      onSubmit="pedirConfirmacion('mensajes', this, './contenidos/postulacion/pedirConfirmacion.php');
    ...
    <!-- CERRAR EL FORMULARIO DE POSTULACION Y HOGAR SANCIONADO -->
    <table cellspacing="0" cellpadding="5" border="0" width="100%" style="padding-bottom: 5px;">
        <tr>
            <td align="left" style="padding-left: 10px;">
                ...
                {else}
                    ...
                    <input type="hidden" name="bolCerrado" id="bolCerrado" value="{$objFormulario->bolCerrado}">
                {/if}
            </td>
        ...
        {if $objFormulario->bolSancion == 1}
            <tr>
                <td style="background-color: #FF0000; color:white; text-align: center" colspan="2">
    ...
    <div id="postulacion" class="yui-navset" style="width:100%; text-align:left;">
        ...
        <div class="yui-content">
            ...
            <div id="frm" style="">
                ...
                <table cellspacing="0" cellpadding="3" border="0" style="width:100%; padding-bottom: 5px;">
                    <tr>
                ...
                <div id="pestanasPostulacion" class="yui-navset" style="width:100%; text-align:left;">
                    ...
                    <div class="yui-content">
                        ...
                        <div id="composicion" style="height:400px; overflow:auto;">
                            <p>
                            ...
                            <table cellpadding="5" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF">
                                <tr>
                                    ...
                                    <td class="tituloTabla">Vigencia del {if $objFormulario->seqPlanGobierno == 2}SDV{else}Aporte{/if}:</td>
                                </tr>
                                <tr>
                        ...
                        <!-- DATOS DEL HOGAR -->
                        <div id="hogar" style="height:400px;">
                            <p>
                            <p>
                            <table cellpadding="2" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF"  style="border: 1px dotted #999999; padding:5px">
                                ...
                                <tr>
                                    ...
                                    <td id="tdupz">
                                        &nbsp;<input type='hidden' id='seqUpz' name='seqUpz' value="{$objFormulario->seqUpz}">
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF" style="border: 1px dotted #999999; padding:5px">
                                <tr>
                                    <!-- INTEGRACION SOCIAL -->
                                    <td width="110px">Integraci&oacute;n Social
                                        <select	onFocus="this.style.backgroundColor = '#ADD8E6';"
                                                onBlur="this.style.backgroundColor = '#FFFFFF';"
                                    ...
                                    <!-- SEC SALUD -->
                                    {if $objFormulario->seqPlanGobierno != 3}
                                        <td width="110px" align="right">Sec. Salud&nbsp;&nbsp;
                                            <select	onFocus="this.style.backgroundColor = '#ADD8E6';"
                                                    onBlur="this.style.backgroundColor = '#FFFFFF';"
                                                    name="bolSecSalud"
                                                    id="bolSecSalud"
                                        ...
                                        <!-- SEC EDUCACION -->
                                        <td width="110px" align="right">Sec. Educacion&nbsp;&nbsp;
                                            <select	onFocus="this.style.backgroundColor = '#ADD8E6';"
                                                    onBlur="this.style.backgroundColor = '#FFFFFF';"
                                    ...
                                    <input type="hidden" name="bolSecMujer" value="{$objFormulario->bolSecMujer|@intval}">                                               

                                {else}
                                    <td width="200px" align="center">Sec. de la Mujer&nbsp;&nbsp;
                                        <select	onFocus="this.style.backgroundColor = '#ADD8E6';"
                                                onBlur="this.style.backgroundColor = '#FFFFFF';"
                                                name="bolSecMujer"
                                                id="bolSecMujer"
                                ...
                                <!-- IPES -->
                                <td width="110px" align="left">IPES&nbsp;&nbsp;
                                    <select	onFocus="this.style.backgroundColor = '#ADD8E6';"
                                            onBlur="this.style.backgroundColor = '#FFFFFF';"
                                            name="bolIpes"
                                            id="bolIpes"
                        ...
                        <div id="modalidad" style="height:400px;">
                            <p>
                            <table cellpadding="3" cellspacing="0" border="0" width="100%" style="border: 1px dotted #666666;">
                                    ...
                                    <td id="tdConjuntoResidencial" colspan="3" align="left">
                                        <select onFocus="this.style.backgroundColor = '#ADD8E6';"
                                            ...
                                            {foreach from=$arrProyectosHijos key=seqProyecto item=txtNombreProyecto}
                                                <option value="{$seqProyecto}"
                                                        {if $objFormulario->seqProyectoHijo == $seqProyecto} selected {/if}
                                                        >
                                                    {$txtNombreProyecto}
                                                </option>
                                            {/foreach}
                                        ...
                                        <select onFocus="this.style.backgroundColor = '#ADD8E6';"
                                            ...
                                            {foreach from=$arrUnidadProyecto key=seqUnidadProyecto item=txtNombre}
                                                <option value="{$seqUnidadProyecto}"
                                                        {if $objFormulario->seqUnidadProyecto == $seqUnidadProyecto} selected {/if}
                                                        >
                                                    {$txtNombre}
                                                </option>
                                            {/foreach}
                                ...
                                <tr>
                                    <td>
                                        <div id="divEsqOtros">
                                            <a href="#"
                                               id="DireccionSolucion"
                                               onClick="recogerDireccion('txtDireccionSolucion', 'objDireccionOcultoSolucion')"
                                               >
                                                Dirección Solución
                                            </a>
                                        </div>
                                ...
                                <tr bgcolor="#E0E0E0">
                                    ...
                                    <td align="right" style="padding-right:5px" id="tdValSubsidio" height="25px" align="top">
                                        $ <input type="text"
                                                 ...
                                                 value="{$objFormulario->valAspiraSubsidio|number_format:'0':'.':'.'}"
                                                 onFocus="this.style.backgroundColor = '#ADD8E6';"
                                                 onBlur="this.style.backgroundColor = '#FFFFFF';"
                                                 style="padding-right: 5px; width:100px; text-align:right;"
                                                 readonly
                                    ...
                                    {else}
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    <input type="hidden" name="txtSoporteSubsidio" value="{$objFormulario->txtSoporteSubsidio}">
                                {/if}
                                </tr>
    ...
    <input type="hidden" id="valAporteLote"        name="valAporteLote"        value="{$objFormulario->valAporteLote}">
    <input type="hidden" id="valAporteAvanceObra"  name="valAporteAvanceObra"  value="{$objFormulario->valAporteAvanceObra}">
    <input type="hidden" id="valAporteMateriales"  name="valAporteMateriales"  value="{$objFormulario->valAporteMateriales}">
