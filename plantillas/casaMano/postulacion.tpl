   ...
   {assign var=txtFuncion value="pedirConfirmacion('mensajes', this, './contenidos/postulacionIndividual/pedirConfirmacion.php')"}-->
    
    <form name="frmIndividual" id="frmIndividual" onSubmit="{$txtFuncion}; return false;" autocomplete=off >	
                ...
                <table cellspacing="0" cellpadding="3" border="0">
                    <tr>
                        ...
                        <!--<td style="width:350px;" align="left">
                            {if $objFormulario->seqEstadoProceso == 53 || $objFormulario->seqEstadoProceso == 54}
                                <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                        onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                        name="seqEstadoProceso"
                                        id="seqEstadoProceso"
                                    ...
                                    <optgroup label="Atras">
                                        <option value="37">{$arrEstado.37}</option>
                                    </optgroup>
                                    <optgroup label="Adelante">
                                        <option value="53" {if $objFormulario->seqEstadoProceso == 53} selected {/if}>
                                            {$arrEstado.53}
                                        </option>
                                        <option value="54" {if $objFormulario->seqEstadoProceso == 54} selected {/if}>
                                            {$arrEstado.54}
                                        </option>
                                    </optgroup>
                                </select>
                  ...
                  this.style.backgroundColor = '#FFFFFF';" 
                        ...
                        <td id="tdlocalidad">
                            <select	onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                    ...
                                    style="width:260px;"
                                    >
                                <option value="1" selected>Seleccione{$seqLocalidad}a{$objFormulario->seqLocalidad}</option>
            ...
            <table cellpadding="3" cellspacing="0" border="0" width="100%" style="border: 1px dotted #666666;">
                ...
                <tr>
                    ...
                    <td id="tdProyecto" colspan="3" align="left">
                        <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                onChange="obtenerDatosProyecto( this , {$objFormulario->seqPlanGobierno} ); obtenerUnidadProyecto(this);"
                                name="seqProyecto" 
                                id="seqProyecto" 
                                style="width:100%"
                                >
