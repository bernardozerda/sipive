...
class Ciudadano {
    ...
    public function ValidarMovilizacion($seqFormulario) {
        ...
        $sql = "
            ...
            WHERE T_FRM_FORMULARIO.seqFormulario = " . $seqFormulario . " and T_FRM_ESTADO_PROCESO.seqEstadoProceso in(1,5,8,10,11,12,13,14,18,21,35,36,37,39,52) and bolCerrado = 0  ";
        try {
            $objRes = $aptBd->execute($sql);
            if ($objRes->fields) {
