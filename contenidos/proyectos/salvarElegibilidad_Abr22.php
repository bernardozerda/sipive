...
if( ( ! isset( $_POST['fchRadicadoJuridico'] ) ) or (trim( $_POST['fchRadicadoJuridico'] ) == "") ){
	$arrErrores[] = "Debe diligenciar la fecha del Radicado Jur&iacute;dico";
}
...
if( ( ! isset( $_POST['fchRadicadoTecnico'] ) ) or (trim( $_POST['fchRadicadoTecnico'] ) == "") ){
	$arrErrores[] = "Debe diligenciar la fecha del Radicado T&eacute;cnico";
}
...
if( ( ! isset( $_POST['fchRadicadoFinanciero'] ) ) or (trim( $_POST['fchRadicadoFinanciero'] ) == "") ){
	$arrErrores[] = "Debe diligenciar la fecha del Radicado Financiero";
}
...
if ( $_POST['bolAprobacion'] == 1 ){
	...
	if ($_POST['bolCondicionAprobacion'] == 1){
		if ( $_POST['txtCondicionAprobacion'] == "" ) {
			$arrErrores[] = "Debe diligenciar el campo Condiciones de Aprobaci&oacute;n";
		}
	}
}
...
/*if( ( ! isset( $_POST['txtResuelve'] ) ) or (trim( $_POST['txtResuelve'] ) == "") ){
	$arrErrores[] = "Debe diligenciar el campo Resuelve";
}*/
...
if (empty($arrErrores)) {
	...
	//if (empty($claCiudadano->arrErrores)) {
		...
		$claProyecto->fchRadicadoJuridico =				$_POST['fchRadicadoJuridico'];
		$claProyecto->numRadicadoTecnico =				$_POST['numRadicadoTecnico'];
		$claProyecto->fchRadicadoTecnico =				$_POST['fchRadicadoTecnico'];
		$claProyecto->numRadicadoFinanciero =			$_POST['numRadicadoFinanciero'];
		$claProyecto->fchRadicadoFinanciero =			$_POST['fchRadicadoFinanciero'];
		$claProyecto->bolAprobacion =					$_POST['bolAprobacion'];
		$claProyecto->numActaAprobacion =				$_POST['numActaAprobacion'];
		$claProyecto->fchActaAprobacion =				$_POST['fchActaAprobacion'];
		...
		$claProyecto->txtActaResuelve =					$_POST['txtActaResuelve'];
		$claProyecto->bolCondicionAprobacion =			$_POST['bolCondicionAprobacion'];
		$claProyecto->txtCondicionAprobacion =			$_POST['txtCondicionAprobacion'];
		$claProyecto->txtObservacionAprobacion =		$_POST['txtObservacionAprobacion'];
		
		$claProyecto->numResolucionProyecto =			$_POST['numResolucionProyecto'];
		
		$claProyecto->ingresarResolucionesProyecto($seqProyecto, $_POST['numResolucionProyecto']);
		$claProyecto->ingresarActasProyecto($seqProyecto, $_POST['numActaProyecto']);
