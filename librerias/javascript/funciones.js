...
function addConjuntoResidencial() {
    ...
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Escritura </label><br /><input name='fchEscrituraHijo[]' type='text' id='fchEscrituraHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/><a href='#' onClick='javascript: calendarioPopUp( \"fchEscrituraHijo_" + indiceFilaFormulario + "\" ); '><img src='recursos/imagenes/calendar.png'></a><div id=\"val_fchEscrituraHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    ...
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Licencia </label><br /><input name='fchLicenciaUrbanismo1Hijo[]' type='text' id='fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\" /><a href='#' onClick='javascript: calendarioPopUp( \"fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "\" ); '><img src='recursos/imagenes/calendar.png'></a><div id=\"val_fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Vigencia&nbsp;Licencia </label><br /><input name='fchVigenciaLicenciaUrbanismoHijo[]' type='text' id='fchVigenciaLicenciaUrbanismoHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/><a href='#' onClick='javascript: calendarioPopUp( \"fchVigenciaLicenciaUrbanismoHijo_" + indiceFilaFormulario + "\" ); '><img src='recursos/imagenes/calendar.png'></a><div id=\"val_fchLicenciaUrbanismo1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    ...
    addDiv += "<div class='col-md-3'><label class='control-label' >Fecha&nbsp;Licencia </label><br /><input name='fchLicenciaConstruccion1Hijo[]' type='text' id='fchLicenciaConstruccion1Hijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/><a href='#' onClick='javascript: calendarioPopUp( \"fchLicenciaConstruccion1Hijo_" + indiceFilaFormulario + "\" ); '><img src='recursos/imagenes/calendar.png'></a><div id=\"val_fchLicenciaConstruccion1Hijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
    addDiv += "<div class='col-md-3'><label class='control-label' >Vigencia&nbsp;Licencia </label><br /><input name='fchVigenciaLicenciaConstruccionHijo[]' type='text' id='fchVigenciaLicenciaConstruccionHijo_" + indiceFilaFormulario + "' size='8' style='width: 60%;position: relative; float: left; background-color:#E4E4E4' readonly class=\"form-control required4\"/><a href='#' onClick='javascript: calendarioPopUp( \"fchVigenciaLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" ); '><img src='recursos/imagenes/calendar.png'></a><div id=\"val_fchVigenciaLicenciaConstruccionHijo_" + indiceFilaFormulario + "\" class=\"divError\">Diligenciar Campo</div></div>";
