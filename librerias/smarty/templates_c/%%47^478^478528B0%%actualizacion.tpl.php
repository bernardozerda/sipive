<?php /* Smarty version 2.6.26, created on 2017-05-05 12:30:24
         compiled from subsidios/actualizacion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'subsidios/actualizacion.tpl', 636, false),array('modifier', 'number_format', 'subsidios/actualizacion.tpl', 665, false),array('function', 'math', 'subsidios/actualizacion.tpl', 637, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['txtTipoDocumento']; ?>
    ...
    foreach ($_from as $this->_tpl_vars['seqParentesco'] => $this->_tpl_vars['arrRegistro']):
?>
							    <option value="<?php echo $this->_tpl_vars['seqParentesco']; ?>
"
                                                            	<?php if ($this->_tpl_vars['arrRegistro']['bolActivo'] == 0): ?>
                                                                        style="color:#666666"
                                                                        disabled
                                                                    <?php endif; ?>	
                                                            >																					<?php echo $this->_tpl_vars['arrRegistro']['txtParentesco']; ?>
															      </option>
							<?php endforeach; endif; unset($_from); ?>
                                                    </select>
                                                </td>
                                            ...
                                            <tr >
                                                ...
                                                <td align="center">
                                                    <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                            ...
                                                            style="width:90%;"
                                                            >                                                        
                                                       <?php $_from = $this->_tpl_vars['arrSalud']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['seqSalud'] => $this->_tpl_vars['txtSalud']):
?>
                                                            <option value="<?php echo $this->_tpl_vars['seqSalud']; ?>
"><?php echo $this->_tpl_vars['txtSalud']; ?>
</option>
                                                        <?php endforeach; endif; unset($_from); ?>                                                      
                                                    </select>
                                                </td>
...
"
 ...
 <?php echo $this->_tpl_vars['objCiudadano']->txtApellido2; ?>
                                            ...
                                            <td width="260px">
                                                <?php echo $this->_tpl_vars['arrParentesco'][$this->_tpl_vars['parentesco']]['txtParentesco']; ?>
...
">
                                        <input type="hidden" id="<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
-seqSalud" name="hogar[<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
][seqSalud]" value="<?php echo $this->_tpl_vars['objCiudadano']->seqSalud; ?>
">
...
" 
    ...
    foreach ($_from as $this->_tpl_vars['seqSisben'] => $this->_tpl_vars['arrRegistro']):
?>
...
"
                                                        ...
                                                        <?php if ($this->_tpl_vars['arrRegistro']['bolActivo'] == 0): ?>
                                                    			...
                                                    			disabled
                                                    	  <?php endif; ?>	
                                                        ><?php echo $this->_tpl_vars['arrRegistro']['txtSisben']; ?>
</option>
                                            <?php endforeach; endif; unset($_from); ?>
                                        </select>
                                    </td>
