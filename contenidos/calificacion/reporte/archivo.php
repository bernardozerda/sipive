...
<html lang="es">
    ...
    <body> 
        <div id="contenidos" class="container" style="width: 60%">
            <div class="hero-unit-header" style="background-color: #289bae; color: white; text-align: center">
                M&oacute;dulo de Calificacion de Encuestas
            </div>
            <div class="well">
                <form method="post" action="contenidos/calificacion/cruceCalificacion.php" enctype="multipart/form-data" id="formcargar" class="form-signin">
                    <div class="form-group">
                        ...
                        Ingrese en un archivo de texto los documentos para legalizar<br><br>                       
                            ...
                            <br><p align="center"><button type="submit" name = "subir" class="btn btn-primary">Descargar</button></p>
                            </form>
                    </div>
            </div> <!-- /container -->
