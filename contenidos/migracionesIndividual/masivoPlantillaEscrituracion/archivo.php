    ...
    <body> 
        <div id="contenidos" class="container">
            <div class="hero-unit-header" style="background-color: #289bae; color: white; text-align: center">
                Modulo Carga Masiva de Escrituraci&oacute;n
            </div>
            <div class="well">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p id="body" style="display: none; text-align: justify">Documento - desembolso - formulario - vendedor - docVendedor - barrio - localidad - vJuridico - vTecnico - seqTipoDoc - 
                                ...
                                Valor inmueble - Tipo de predio - Estrato - Folio Escritura publica - Obs Escritura Publica - Folio de certificado de tradición -
                                Obs Certificado de Tradicion - Folio carta asignación - Obs Carta de Asignacion - Folio Alto Riesgo - Obs Alto Riesgo - 
                                Folio Habitabilidad - Obs Habitabilidad - Folio Boletin Catastral. - Obs Boletin Catastral - Folio Licencia de Construcción - 
                                Obs Licencia de Construcción - Folio Ultimo predial - Obs Ultimo predial - Folio Ultimo Recibo de Agua - Obs Ultimo Recibo de Agua - 
                                Folio Ultimo Recibo de Energia - Obs Ultimo Recibo de Energia - Folio Acta Entrega - Obs Acta Entrega - Folio Certificado Vendedor - 
                                Obs Certificado Vendedor - Folio Autorizacion Desembolso - Obs Autorizacion Desembolso - Folio Fotocopia Vendedor - 
                                Obs Fotocopia Vendedor - Folio Rit - Obs Rit - Folio Rut - Obs Rut - Folio Nit - Obs Nit - Folio Otros - Obs Otros
                            </p>
                        </div>
