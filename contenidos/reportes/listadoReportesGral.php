...
$arrayReportes = $claReporte->obtenerlistaReportesGral('');
?>
<head>
    <meta charset="utf-8">
        ...
        <div class="thumbnail" style="min-height: 500px; ">
            <div class="caption">                
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0"  >
                    ...
                    <?php foreach ($arrayReportes as $keyReportes => $valueReportes) { ?>
                        ...
                        <tr align="center">
                            ...
                            <td style="text-align: center"><a class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="$('#name').val('<?= $valueReportes['txtNombreReporte'] ?>');" href="#"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor: pointer; text-align: center"></span></a></td>
