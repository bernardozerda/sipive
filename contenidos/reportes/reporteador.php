<?php
	...
	if( !file_exists( $txtPrefijoRuta . $arrConfiguracion['librerias']['funciones'] . "funciones.php" )){
	    ...
	    $claSmarty->assign( "txtArchivoInicio" , "reportes/reporteador.tpl"  );
...
//        pr($arrCamposDesembolso);
    ...
    $claSmarty->assign( "txtArchivoAyuda", "reportes/ayudaReporteador.tpl" );
    
    
    if( $mostrarPlantilla ){
    	$claSmarty->display( "reportes/reporteador.tpl" );
    }
