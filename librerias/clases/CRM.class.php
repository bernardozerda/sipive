<?php
	...
	class CRM {
	    ...
	    function reporteIndicadoresDiaSemanaMes( $txtTipoReporte, $txtEstado ){
	    	...
	    	$txtInnerJoin 	= ( is_array( $arrQueries["innerJoin"] ) )?implode( " ", $arrQueries["innerJoin"] ):$arrQueries["innerJoin"];trim( $arrQueries["innerJoin"] );
	    	$txtRangos 		= ( is_array( $arrQueries["rangos"] ) )?implode( " OR ", $arrQueries["rangos"] ):$arrQueries["rangos"];trim( $arrQueries["rangos"] );
