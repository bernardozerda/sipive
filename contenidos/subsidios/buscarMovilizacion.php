...
if (!isset($_POST['cedula'])) {
    ...
    if ($seqFormulario == 0) {
        ...
        if ($validarMovilizacion > 0) {
            ...
            echo "<p><br><div class='msgError'>El estado de avance del hogar en el proceso no permite generación directa de la carta. Se solicita que"
            . " el ciudadano radique solicitud formal en la Sede Principal para que sea atendida por el equipo de desembolsos "
            . "de la Subsecretaria de Gestión Financiera</div></p>";
        }
...
and seqFormulario = $seqFormulario";
    ...
    $grupo = 0;
    if (array_key_exists(9, $_SESSION['arrGrupos'] [3])) {
        $grupo = 1;
    }
    if (in_array(5, $_SESSION["arrGrupos"])) {
        $grupo = 1;
    }
