...
<table cellpadding="0" cellspacing="0" border="0" width="99%" height="500px">
    <tr>
        <td width="300px" align="center" valign="top" id="filtros">
            {include file="aad/filtros.tpl"}
        </td>
        <td rowspan="2" align="center" valign="top" id="informacion">
            {include file="aad/informacion.tpl"}
        </td>
    </tr>
    <tr>
