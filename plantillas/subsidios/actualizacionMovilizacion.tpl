                        ...
                        <div id="movilizacion" style="height:415px;"><p>
                            <table cellpadding="1" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF" height='60%'>
                                <tr>
                                    ...
                                    <td colspan="2" align="center"><b>{$nombrePostulante}</b>
                                        <!--   <input	type="text" 
                                                  name="namePostulado1" 
                                                  id="valPostulado1" 
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: center" ><br>
                                        ...
                                        <div onclick="confirmarCartaMovilizacion({$numDocumento}, 1, '{$nombrePostulante}')" style="width:70px; text-align: center; border: 1px solid #000; background: #F5F5F5; position: relative; left: 44% ">
