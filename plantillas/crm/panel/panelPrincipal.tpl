            ...
            <div>
                <p>
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" >
                        ...
                        <tr>
                            <th>{$nombreEstado}</th>                            
                            <td align="center"><div class="grey">{$datos.$txtEstadoVal}</div></td>
                            <td align="center"><div class="blue">{$totalNoProy}</div></td>
                            <td align="center"><div class="orange">{$totalNoProy+$datos.$txtEstadoVal}</div></td>
                        </tr>

                    {/foreach}   
                    <tr>
                        <th bgcolor="#008FA6" style="text-align: center; font-weight: bold; color: #fff">Total</th>
                        <th bgcolor="#008FA6" style="text-align: center; font-weight: bold; color: #fff">{$totalCon}</th>
                        <th bgcolor="#008FA6" style="text-align: center; font-weight: bold; color: #fff">{$totalSin}</th>
                        <th bgcolor="#008FA6" style="text-align: center; font-weight: bold; color: #fff">{$totalSin+$totalCon}</th>
                    </tr>
                </table>
            {/foreach} 
            </p>
